        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => onToggleActive(supplier.id, !supplier.active)}>
                <Power className="mr-2 h-4 w-4" />{supplier.active ? "Desactivar" : "Activar"}
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <ConfirmDialog
                trigger={
                ...
                description={`Se eliminará "${supplier.name}" permanentemente.`}
